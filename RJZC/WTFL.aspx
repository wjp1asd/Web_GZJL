                                                                ...
                                                                <table cellpadding="0" cellspacing="0" class="td2" style="border-collapse: collapse">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="297" align="left">
                                                                            <asp:TextBox ID="txt_lbmcbz" runat="server" Width="297px" MaxLength="100"></asp:TextBox>
                                                                        </td>
                                                                          <td width="1px"></td>
                                                            ...
                                                            <td>
                                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderWidth="0px"
                                                                    ...
                                                                    <Columns>
                                                                       ...
                                                                       <%--两部分代码都可用 <asp:TemplateField HeaderText="编辑" ShowHeader="False">
                                                                            <EditItemTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="删除">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="LinkButton4" runat="server" CausesValidation="False" CommandName="Delete"
                                                                                    CssClass="a2" Text="删除" OnClientClick=" return confirm('确认删除此耦合剂吗')"></asp:LinkButton>
                                                                            </ItemTemplate>
