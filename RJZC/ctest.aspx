<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ctest.aspx.cs" Inherits="Web_GZJL.RJZC.ctest" %>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" class="td2" style="border-collapse: collapse">
                                                        ...
                                                        <tr style="height:135px;">
                                                            ...
                                                            <td>
                                                                   ...
                                                                   KeyFieldName="Id" AllowSorting="true" PageSize="20" GridLines="None" DataKeyNames="id" OnSelectedIndexChanging="GridView1_SelectedIndexChanging" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowDeleting="GridView1_RowDeleting">
                                                                    <Columns>
                                                                      ...
                                                                      <asp:BoundField DataField="Id" HeaderText="id" Visible="false"  ItemStyle-CssClass ="hidden" HeaderStyle-CssClass="hidden" />
                                                                        ...
                                                                        <asp:TemplateField HeaderText="任务单号 ">
                                                                            ...
                                                                            <EditItemTemplate>
                                                                                <asp:TextBox ID="txt_fh1" runat="server" Text='<%# Bind("ChNo") %>' Width="170px"
                                                                                    MaxLength="50" Height="20px"></asp:TextBox>
                                                                            </EditItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Center" Width="180px" />
                                                                            <HeaderStyle HorizontalAlign="Center" Width="180px" CssClass="dl" />
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lbl_fh1" runat="server" Text='<%# Bind("ChNo") %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
