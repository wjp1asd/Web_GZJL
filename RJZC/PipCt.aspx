                                                            ...
                                                            <td>
                                                                    ...
                                                                    <tr height="2px"  style="text-align:center ;">
                                                                        <td  style="width:150px;"><label  style="    font-size:9px; line-height:31px;padding-top: 12px;margin-right: 5px;" >测厚仪编号</label></td>
                                                                          <td  >
                                                                            <asp:TextBox ID="txt_hbh" runat="server" Width="180px" MaxLength="50"      margin-left=" 5px"></asp:TextBox>
                                                                        </td>
                                                                          ...
                                                                          <td  style="width:150px;"><label  style="     font-size:9px; line-height:31px;padding-top: 12px;margin-right: 5px;" >Mac</label></td>
                                                                          <td width="179" >

                                                                            <asp:TextBox ID="txt_Mac" runat="server" Width="180px" MaxLength="50" ></asp:TextBox>
                                                                        </td>
                                                                       
                                                                                <td  style="width:150px;"><label  style="     font-size:9px; line-height:31px;padding-top: 12px;margin-right: 5px;" >状态</label></td>
                                                                          <td width="179" >
                                                                ...
                                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderWidth="0px"
                                                                    ...
                                                                    <Columns>
                                                                        <asp:TemplateField HeaderText="测厚仪编号 ">
                                                                            <EditItemTemplate>
                                                                                <asp:TextBox ID="txt_no" runat="server" Text='<%# Bind("Sbnumber") %>' Width="170px"
