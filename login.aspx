...
<body>
    ...
    <form id="Form1" method="post" runat="server" style="border-bottom">
        ...
        <table width="993" border="0" align="center"   cellpadding="0" cellspacing="0" style="padding-right: 0px; padding-left: 25%; padding-bottom: 0px; margin: 0px; padding-top: 10%">
            <tbody>
                <tr>
                    <td >
