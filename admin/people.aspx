                                                          ...
                                                          <tr>
                                                            <td>
                                                                    ...
                                                                    <tr height="2px"  style="text-align:center ;">
                                                                        <td  style="width:150px;"><label  style="    font-size:9px; line-height:31px;padding-top: 12px;margin-right: 5px;" >机构名称</label></td>
                                                                          <td  >
                                                                              <asp:DropDownList ID="DropDownList1" runat="server"    width=" 185px"    height=" 22px">
                                                                    </asp:DropDownList>
                                                                        </td>
                                                                           <td  style="width:150px;"><label  style="    font-size:9px; line-height:31px;padding-top: 12px;margin-right: 5px;" >所属职位</label></td>
                                                                           <td width="179">
                                                                             <asp:DropDownList ID="ddl_zhiwu" runat="server"     width=" 185px"    height=" 22px">
