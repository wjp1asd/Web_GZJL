                                                    ...
                                                    <td style="border-bottom: 1px solid #aaaaaa;">
                                                        <table border="0" cellpadding="3" cellspacing="0">
                                                            <tr style="height: 30px">
                                                                <td align="left">
                                                                    <asp:Label ID="lbl_xuanze" runat="server" Text="选择机构："></asp:Label>
                                                                </td>
                                                                <td>
                                                ...
                                                <tr>
                                                    <td align="left" valign="top">
                                                        <%--<asp:GridView ID="gv_ryxx" runat="server" AutoGenerateColumns="False" BorderStyle="None"
                                                            ...
                                                            AllowPaging="True" OnSelectedIndexChanging="gv_ryxx_SelectedIndexChanging" CssClass="auto-style1">
                                                            <Columns>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td id="Td1" align="left" visible="false" runat="server">
