...
namespace Web_GZJL.admin
{
    public partial class XXZXUSER : System.Web.UI.Page
    {
        ...
        public string t1 = "", t0 = ""; string sql = " 1=1 ";
        ...
        private DataTable GetDataToTable()
        {
            ...
            if (sql != " 1=1 ")
            { dt = DataBase.Exe_dt("select ID,czjdqID,usrname,usrzhiwu,bangongdh,shouji,zhaopian  from  tb_czjuser    where  " + ViewState["where"].ToString() + "   ORDER BY id "); }
            else
            {
                dt = DataBase.Exe_dt("select ID,czjdqID,usrname,usrzhiwu,bangongdh,shouji,zhaopian from  tb_czjuser       ORDER BY id ");
            }
            return dt;
        }
        #endregion
        ...
        protected void btn_save_Click(object sender, EventArgs e)
        {
            ...
            //{//czjadds,'" + DataOper.setTrueString(txt_czjdz.Text.Trim()) + "',
            //    str = "insert into TB_CZJDZ(ID,sudq)values('" + lbl_id + "','" + Session["XZQH"].ToString() + "')";
            //}
            //else
            //{//czjadds = '" + DataOper.setTrueString(txt_czjdz.Text.Trim()) + "'
            //    str = "UPDATE TB_CZJDZ SET    WHERE  ID = '" + this.lbl_id.Text + "'";
            //}
