...
//txt_xzqh.Text = "";
        ...
        {
            System.Configuration.ConnectionStringSettings setting = ConfigurationManager.ConnectionStrings["DBConnection"];
            SqlConnection conn = new System.Data.SqlClient.SqlConnection(setting.ToString());
            return conn;
        }
        /// <summary>
        /// 保存
        ...
        protected void but_save_Click(object sender, EventArgs e)
        {
            ...
            {
                //XZQH,,'" + DataOper.setTrueString(txt_xzqh.Text.Trim()) + "'
                sqlstr = "insert into sys_depart(departid,departname,parent,memo,flag,id,XH,tele) values('" + lbl_id.Text.Trim() + "','" + DataOper.setTrueString(txtName.Text.Trim()) + "','" + ViewState["SPath"].ToString() + "','" + DataOper.setTrueString(txtMessage.Text.Trim()) + "','1','" + lbl_id.Text.Trim() + "','" + DataOper.setTrueString(txt_xuhao.Text.Trim()) + "','" + DataOper.setTrueString(TextBox1.Text.Trim()) + "')";
            }
            else
            {//,XZQH='" + DataOper.setTrueString(txt_xzqh.Text.Trim()) + "'
                sqlstr = "update sys_depart set departname='" + txtName.Text.Trim() + "',memo='" + DataOper.setTrueString(txtMessage.Text.Trim()) + "',XH='" + DataOper.setTrueString(txt_xuhao.Text.Trim()) + "' ,tele='" + DataOper.setTrueString(TextBox1.Text.Trim()) + "'   where id='" + TreeView1.SelectedNode.Value + "' ";
            }
